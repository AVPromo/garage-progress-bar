...
before deploying:
  ...
  2. removes our loose leftovers from res_mods/<version>/ (mod_wgmod*.py + their
     .pyc siblings + the wgmod_research package) -- and nothing else (OpenWG's
...
def _clean(mods_dir, res_mods_dir, mod_id):
    ...
    for stem in ("mod_wgmod", "mod_wgmod_debug"):
