...
## Environment (this PC)
- WoT install: `D:\Games\World_of_Tanks_EU`, version **2.3.1.3**. OpenWG Gameface installed (`mods\2.3.1.3\net.openwg`).
...
the overlay** (`res_mods\2.3.1.3\gui\gameface\mods\14th_ua\`) before a clean
...
- Build/deploy it (client closed):
  `& "C:\Python27\python.exe" tools\dev\build_debug_wotmod.py "D:\Games\World_of_Tanks_EU" 2.3.1.3`
