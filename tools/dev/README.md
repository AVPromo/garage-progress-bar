...
## Environment (this PC)
- WoT install: `D:\Games\World_of_Tanks_EU`, version **2.3.1.1**. OpenWG Gameface installed (`mods\2.3.1.1\net.openwg`).
...
the overlay** (`res_mods\2.3.1.1\gui\gameface\mods\14th_ua\`) before a clean
