==============================================================
 Garage Progress Bar  -  World of Tanks mod (EU 2.3.1.2)
...
INSTALL  (2 steps)
    ...
    The version folder (2.3.1.2) must match your installed client
...
ВСТАНОВЛЕННЯ  (2 кроки)
    ...
    Тека версії (2.3.1.2) має збігатися з версією вашого клієнта.
