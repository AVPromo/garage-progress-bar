...
2. Run **`GarageProgressBar-Setup-1.3.2.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_1.3.2.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_1.3.2.wotmod`.
...
`com.14th_ua.garageprogressbar_1.3.2.wotmod` from `mods\<version>\`, then restart the client.
