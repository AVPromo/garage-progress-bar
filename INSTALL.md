...
| Requirement | Detail |
|-------------|--------|
| **Game** | World of Tanks **EU (Wargaming)** client, version **2.3.1.3**. Built and tested against this version. |
...
This build targets the Wargaming EU/global client (version 2.3.1.3).
...
2. Run **`GarageProgressBar-Setup-4.0.0.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_4.0.0.wotmod`** into that folder.
...
The `mods\2.3.1.3\` folder then holds the OpenWG GameFace `.wotmod` and
`com.14th_ua.garageprogressbar_4.0.0.wotmod`.
...
`com.14th_ua.garageprogressbar_4.0.0.wotmod` from `mods\<version>\`, then restart the client.

---

*Mod by 14th_ua. Built for WoT EU 2.3.1.3.*
