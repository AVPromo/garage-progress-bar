...
2. Run **`GarageProgressBar-Setup-1.3.3.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_1.3.3.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_1.3.3.wotmod`.
...
`com.14th_ua.garageprogressbar_1.3.3.wotmod` from `mods\<version>\`, then restart the client.
