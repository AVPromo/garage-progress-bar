...
This build targets the Wargaming EU/global client (version 2.3.1.1).
...
2. Run **`GarageProgressBar-Setup-2.0.0.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_2.0.0.wotmod`** into that folder.
...
The `mods\2.3.1.1\` folder then holds the OpenWG GameFace `.wotmod` and
`com.14th_ua.garageprogressbar_2.0.0.wotmod`.
...
`com.14th_ua.garageprogressbar_2.0.0.wotmod` from `mods\<version>\`, then restart the client.
