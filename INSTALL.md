...
3. Copy **`com.14th_ua.garageprogressbar_3.3.1.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_3.3.1.wotmod`.
...
`com.14th_ua.garageprogressbar_3.3.1.wotmod` from `mods\<version>\`, then restart the client.
