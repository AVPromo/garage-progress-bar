...
```sh
python build/deploy_wotmod.py "D:/Games/World_of_Tanks_EU" 2.3.1.2
# or create deploy.local.json (gitignored): { "wot_path": "...", "version": "2.3.1.2" }
...
```sh
python tools/dev/sync_gameface.py "<install>" 2.3.1.2
...
- Built for the **Wargaming EU/global** client (version 2.3.1.2) only.
