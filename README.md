...
| Requirement | Detail |
|-------------|--------|
| **Game** | World of Tanks **EU 2.3.1.3** (Wargaming global client). Built and tested against this version. |
...
| Вимога | Деталі |
|--------|--------|
| **Гра** | World of Tanks **EU 2.3.1.3** (глобальний клієнт Wargaming). Зібрано й перевірено для цієї версії. |
